...
12. [Pengenalan programming menggunakan JavaScript di You Don't Know
    JS](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/get-started/ch1.md) memberikan
    gambaran komprehensif tentang sintaksis dasar JavaScript.
13. [Konstruksi dasar JavaScript](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/get-started/ch2.md) memberikan penjelasan yang lebih rinci tentang sintaksis dasar dari JavaScript. 
